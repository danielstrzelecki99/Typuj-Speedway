...
<body>
    ...
    <div id="i"></div>
    <h1>Ewinner I Liga: kolejka I (10.04.2022 - 11.04.2022)</h1>
    <div class="container">
        <div class="card">
            <div class="part date">
                <h3>10.04.2022</h3>
            ...
            <div class="part">
                <div class="content">
                    <div class="imgBx"><img src="img/falubaz-logo.png"></div>
                    <div class="contentBx">
                        <h3>Falubaz<br><span>Zielona Góra</span></h3>
                    </div>
                </div>
                <div class="content">
                    <div class="imgBx"><img src="img/gniezno-logo.png"></div>
                    <div class="contentBx">
                        <h3>Start<br><span>Gniezno</span></h3>
                    </div>
                </div>
            </div>
            <div class="typowanie">
        ...
        <div class="card">
            ...
            <div class="part">
                <div class="content">
                    <div class="imgBx"><img src="img/devils-logo.jpg"></div>
                    <div class="contentBx">
                        <h3>Devils<br><span>Landshut</span></h3>
                    </div>
                </div>
                <div class="content">
                    <div class="imgBx"><img src="img/byd-logo.png"></div>
                    <div class="contentBx">
                        <h3>Polonia<br><span>Bydgoszcz</span></h3>
                    </div>
                </div>
            </div>
            <div class="typowanie">
        ...
        <div class="card">
            ...
            <div class="part">
                <div class="content">
                    <div class="imgBx"><img src="img/gda-logo.jpg"></div>
                    <div class="contentBx">
                        <h3>Wybrzeże<br><span>Gdańsk</span></h3>
                    </div>
                </div>
                <div class="content">
                    <div class="imgBx"><img src="img/kro-logo.png"></div>
                    <div class="contentBx">
                        <h3>Wilki<br><span>Krosno</span></h3>
                    </div>
                </div>
            </div>
            <div class="typowanie">
        ...
        <div class="card">
            ...
            <div class="part">
                <div class="content">
                    <div class="imgBx"><img src="img/lodz-logo.png"></div>
                    <div class="contentBx">
                        <h3>Orzeł<br><span>Łódź</span></h3>
                    </div>
                </div>
                <div class="content">
                    <div class="imgBx"><img src="img/row-logo.png"></div>
                    <div class="contentBx">
                        <h3>ROW<br><span>Rybnik</span></h3>
                    </div>
                </div>
            </div>
            <div class="typowanie">
    ...
    <div class="podsumowanieKolejki">
        ...
        <div class="punktyKolejki">
            <h3>Punkty zdobyte w kategorii I liga: </h3>
            <div>
                <h3>X</h3>
            </div>
        </div>
    ...
    <div id="ii"></div>
    <h1>Ewinner I Liga: kolejka II (16.04.2022 - 17.04.2022)</h1>
    <div class="container">
        <div class="card">
            <div class="part date">
                <h3>16.04.2022</h3>
    ...
    <div id="iii"></div>
    <h1>PGE Ekstraliga: kolejka III (24.04.2022 - 25.04.2022)</h1>
    <div class="container">
        <div class="card">
            <div class="part date">
                <h3>24.04.2022</h3>
    ...
    <div id="iv"></div>
    <h1>Ewinner I Liga: kolejka IV (01.05.2022 - 02.05.2022)</h1>
    <div class="container">
        <div class="card">
            <div class="part date">
                <h3>01.05.2022</h3>
    ...
    <div id="v"></div>
    <h1>PGE Ekstraliga: kolejka V (07.05.2022 - 08.05.2022)</h1>
    <div class="container">
        <div class="card">
            <div class="part date">
                <h3>07.05.2022</h3>
    ...
    <div id="vi"></div>
    <h1>PGE Ekstraliga: kolejka VI (21.05.2022 - 22.05.2022)</h1>
    <div class="container">
        <div class="card">
            <div class="part date">
                <h3>21.05.2022</h3>
    ...
    <div id="vii"></div>
    <h1>PGE Ekstraliga: kolejka VII (28.05.2022 - 29.05.2022)</h1>
    <div class="container">
        <div class="card">
            <div class="part date">
                <h3>28.05.2022</h3>
    ...
    <div id="viii"></div>
    <h1>PGE Ekstraliga: kolejka VIII (04.06.2022 - 05.06.2022)</h1>
    <div class="container">
        <div class="card">
            <div class="part date">
                <h3>04.06.2022</h3>
    ...
    <div id="ix"></div>
    <h1>PGE Ekstraliga: kolejka IX (11.06.2022 - 12.06.2022)</h1>
    <div class="container">
        <div class="card">
            <div class="part date">
                <h3>11.06.2022</h3>
